...
async def _(bot: Bot, event: Event, state: T_State):
    ...
    if len(argvs) > 2:
        ...
        font = ImageFont.truetype(r"C:\Users\Administrator\Desktop\Eurobot\src\plugins\akat\Torus SemiBold.otf",40)
        font20 = ImageFont.truetype('../msyh.ttc',24)
        font30 = ImageFont.truetype(r"C:\Users\Administrator\Desktop\Eurobot\src\plugins\akat\GOTHIC.ttf",23)
